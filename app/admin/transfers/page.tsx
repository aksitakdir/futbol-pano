  ...
  return (
    <AdminLayout>
      <div className="mx-auto max-w-4xl">
        <div className="mb-6">
          <h1 className="text-xl font-bold">Transfer Wire</h1>
          <p className="text-xs text-slate-400">
            RSS headlines, confirmed deals for /transfers
          </p>
        </div>
        ...
        {tab === "completed" && !loading ? (
          <section className="space-y-4">
            <p className="text-xs text-slate-500">
              Shown under <strong className="text-slate-300">CONFIRMED DEALS</strong> on /transfers.
            </p>
            <button
              type="button"
