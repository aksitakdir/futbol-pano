...
export default function EnListelerDetailPage() {
  ...
  if (notFound || !article)
    return (
      ...
      >
        ...
        <Link href="/en/listeler" className="text-sm" style={{ color: "var(--sg-secondary)" }}>
          ← Back to Lists
        </Link>
      </main>
    );
  ...
  return (
    ...
    >
      {playerCardData && (
        <div className="mb-8">
          <p className="mb-3 text-[11px] font-bold uppercase tracking-[0.2em]" style={{ color: "var(--sg-secondary)", fontFamily: "var(--font-headline)" }}>
            Player Card
          </p>
          <PlayerCard
