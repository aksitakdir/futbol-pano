...
function listSummaryEn(item: Content, max = 200): string {
  ...
  return (
    <main style={{ background: "var(--sg-bg)", color: "var(--sg-text-primary)", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 1440, margin: "0 auto", padding: "0 32px 80px" }}>
        ...
        {!loading && featured ? (
          <Link
            href={`/en/listeler/${featured.slug}`}
            className="lift"
            style={{
              display: "block",
              position: "relative",
            ...
            <div style={{ position: "relative", padding: "48px", maxWidth: 760 }}>
              ...
              <div style={{ marginTop: 24, display: "flex", gap: 12, alignItems: "center", flexWrap: "wrap" }}>
                ...
                <span className="mono" style={{ fontSize: 10, letterSpacing: "0.16em", color: "var(--sg-text-muted)" }}>
                  {estimateReadMinutes(featuredBodyForRead)} MIN
                </span>
              </div>
            </div>
          </Link>
                  ...
                  <Link key={item.id} href={`/en/listeler/${item.slug}`}
                    ...
                    <div style={{ padding: 28, flex: 1, display: "flex", flexDirection: "column" }}>
                      ...
                      <div style={{ marginTop: "auto", paddingTop: 16, borderTop: "1px solid var(--sg-border)" }}>
                        {pills.length > 0 ? (
                          <ContentHighlightPills tags={pills} accent={accent} label="HIGHLIGHTS" />
                        ) : null}
